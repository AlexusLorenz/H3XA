...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Trade History"), Category = "SteamCoreWeb|EconService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Flush Inventory Cache"), Category = "SteamCoreWeb|EconService|Async")
...
public:
	...
	* @param
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Flush Asset Appearance Cache"), Category = "SteamCoreWeb|EconService|Async")
...
public:
	...
	* @param
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Flush Context Cache"), Category = "SteamCoreWeb|EconService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Trade Offers"), Category = "SteamCoreWeb|EconService|Async")
...
public:
	...
	* @param
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Trade Offer"), Category = "SteamCoreWeb|EconService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Trade Offers Summary"), Category = "SteamCoreWeb|EconService|Async")
...
public:
	...
	* @param	TradeOfferId
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Decline Trade Offer"), Category = "SteamCoreWeb|EconService|Async")
