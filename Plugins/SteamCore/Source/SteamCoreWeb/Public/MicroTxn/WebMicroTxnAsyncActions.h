...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Adjust Agreement"), Category = "SteamCoreWeb|MicroTxn|Async")
...
public:
	...
	* @param	AppId				App ID of the game the agreement is for.
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Cancel Agreement"), Category = "SteamCoreWeb|MicroTxn|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Finalize Txn"), Category = "SteamCoreWeb|MicroTxn|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Report"), Category = "SteamCoreWeb|MicroTxn|Async")
...
public:
	...
	* @param	AppId				App ID for game.
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get User Agreement Info"), Category = "SteamCoreWeb|MicroTxn|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get User Info"), Category = "SteamCoreWeb|MicroTxn|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Init Txn", AutoCreateRefTerm = "category, associatedBundle, billingType, startDate, endDate, period, frequency, recurringAmt, bundleCount, bundleID, bundleQty, bundleDesc, bundleCategory"), Category = "SteamCoreWeb|MicroTxn|Async")
