...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Market Eligibility"), Category = "SteamCoreWeb|EconMarketService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Cancel App Listings for User"), Category = "SteamCoreWeb|EconMarketService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Asset ID"), Category = "SteamCoreWeb|EconMarketService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Popular"), Category = "SteamCoreWeb|EconMarketService|Async")
