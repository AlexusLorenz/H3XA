...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Recently PlayedGames"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Owned Games"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	* @param	SteamId						The player we're asking about
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Steam Level"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	* @param	SteamId			The player we're asking about
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Badges"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Community Badge Progress"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Is Playing Shared Game"), Category = "SteamCoreWeb|PlayerService|Async")
