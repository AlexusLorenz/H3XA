...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Ranked by Publication Order", AutoCreateRefTerm = "Tag,UserTag"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	* @param	UserTag					A user specific Tag
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Ranked by Trend", AutoCreateRefTerm = "Tag,UserTag"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	* @param	UserTag					A user specific Tag
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Ranked by Vote", AutoCreateRefTerm = "Tag,UserTag"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	* @param	UserTag					A user specific Tag
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Result Set Summary", AutoCreateRefTerm = "Tag,UserTag"), Category = "SteamCoreWeb|PlayerService|Async")
