...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = ""), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Collection Details"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	* @param	publishedFileIDs		collection ids to get the details for
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Published File Details"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	* @param	AppId			AppId of product
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get UGC File Details"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Set UGC Used By GC"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Subscribe Published File"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Unsubscribe Published File"), Category = "SteamCoreWeb|PlayerService|Async")
