...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Authenticate User"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Authenticate User Ticket"), Category = "SteamCoreWeb|PlayerService|Async")
