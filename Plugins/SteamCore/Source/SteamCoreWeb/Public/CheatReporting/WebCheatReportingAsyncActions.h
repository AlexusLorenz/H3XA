...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Report Player Cheating"), Category = "SteamCoreWeb|CheatReporting|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Request Player Game Ban"), Category = "SteamCoreWeb|CheatReporting|Async")
...
public:
	...
	* @param	AppId			The App ID for the game.
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Remove Player Game Ban"), Category = "SteamCoreWeb|CheatReporting|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Cheating Reports"), Category = "SteamCoreWeb|CheatReporting|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Report Cheat Data"), Category = "SteamCoreWeb|CheatReporting|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Request VAC Status for User"), Category = "SteamCoreWeb|CheatReporting|Async")
...
public:
	...
	* @param	AppId			The App ID for the game.
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Start Secure Multiplayer Session"), Category = "SteamCoreWeb|CheatReporting|Async")
...
public:
	...
	* @param	SessionId (int64)	The Session ID that was obtained from the call to StartSecureMultiplayerSession.
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "End Secure Multiplayer Session"), Category = "SteamCoreWeb|CheatReporting|Async")
