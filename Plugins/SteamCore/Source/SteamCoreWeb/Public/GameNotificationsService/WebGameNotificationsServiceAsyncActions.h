...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Create Session"), Category = "SteamCoreWeb|GameNotificationsService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Update Session"), Category = "SteamCoreWeb|GameNotificationsService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Enumerate Sessions for App"), Category = "SteamCoreWeb|GameNotificationsService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Session Details for App"), Category = "SteamCoreWeb|GameNotificationsService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Request Notifications"), Category = "SteamCoreWeb|GameNotificationsService|Async")
...
public:
	...
	* @param	SteamId				(Optional) Steam ID to make the request on behalf of -- if specified, the user must be in the session.
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Delete Session"), Category = "SteamCoreWeb|GameNotificationsService|Async")
...
public:
	...
	* @param	AppId				The App ID of the session to delete.
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Delete Session Batch"), Category = "SteamCoreWeb|GameNotificationsService|Async")
