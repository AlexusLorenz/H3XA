...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get History Command Details"), Category = "SteamCoreWeb|GameInventory|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get User History"), Category = "SteamCoreWeb|GameInventory|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "History Execute Commands"), Category = "SteamCoreWeb|GameInventory|Async")
...
public:
	...
	* @param	ContextId		The context to fetch history for
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Support Get Asset History"), Category = "SteamCoreWeb|GameInventory|Async")
