...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Check App Ownership"), Category = "SteamCoreWeb|SteamUser|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get App Price Info"), Category = "SteamCoreWeb|SteamUser|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Friend List"), Category = "SteamCoreWeb|SteamUser|Async")
...
public:
	...
	* @param	Key				Steamworks Web API publisher authentication Key.
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Player Bans"), Category = "SteamCoreWeb|SteamUser|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Player Summaries"), Category = "SteamCoreWeb|SteamUser|Async")
...
public:
	...
	* @param	SteamId			SteamID of user
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Publisher App Ownership"), Category = "SteamCoreWeb|SteamUser|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Publisher App Ownership Changes"), Category = "SteamCoreWeb|SteamUser|Async")
