...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Item Vote Summary", AutoCreateRefTerm = "publishedFileIDs"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	* @param	PublishedFileIds		The Published File ID who's vote details are required
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "User Vote Summary", AutoCreateRefTerm = "publishedFileIDs"), Category = "SteamCoreWeb|PlayerService|Async")
