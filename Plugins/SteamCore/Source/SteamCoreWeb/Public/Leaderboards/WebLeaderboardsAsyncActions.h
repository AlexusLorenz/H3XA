...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Delete Leaderboard"), Category = "SteamCoreWeb|Leaderboards|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Find or Create Leaderboard"), Category = "SteamCoreWeb|Leaderboards|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Leaderboard Entries"), Category = "SteamCoreWeb|Leaderboards|Async")
...
public:
	...
	* @param	AppId				appid of game
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Leaderboards for Game"), Category = "SteamCoreWeb|Leaderboards|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Reset Leaderboard"), Category = "SteamCoreWeb|Leaderboards|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Set Leaderboard Score", AutoCreateRefTerm = "details"), Category = "SteamCoreWeb|Leaderboards|Async")
