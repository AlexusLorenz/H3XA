...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Can Trade"), Category = "SteamCoreWeb|SteamEconomy|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Finalize Asset Transaction"), Category = "SteamCoreWeb|SteamEconomy|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Asset Class Info"), Category = "SteamCoreWeb|SteamEconomy|Async")
...
public:
	...
	* @param	Language		The user's local Language
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Asset Prices"), Category = "SteamCoreWeb|SteamEconomy|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Exported Assets for User"), Category = "SteamCoreWeb|SteamEconomy|Async")
...
public:
	...
	* @param	AppId			The app ID the user is buying assets for
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Market Prices"), Category = "SteamCoreWeb|SteamEconomy|Async")
