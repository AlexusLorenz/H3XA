...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get News for App", AutoCreateRefTerm = "feeds"), Category = "SteamCoreWeb|PlayerService|Async")
...
public:
	...
	* @param	Count			List of feed names to return news for
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get News for App Authed", AutoCreateRefTerm = "feeds"), Category = "SteamCoreWeb|PlayerService|Async")
