...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Add Item"), Category = "SteamCoreWeb|InventoryService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Add Promo Item"), Category = "SteamCoreWeb|InventoryService|Async")
...
public:
	...
	* @param	RequestId (int64)
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Consume Item"), Category = "SteamCoreWeb|InventoryService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Exchange Item"), Category = "SteamCoreWeb|InventoryService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Inventory"), Category = "SteamCoreWeb|InventoryService|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Item Defs"), Category = "SteamCoreWeb|InventoryService|Async", meta = (AutoCreateRefTerm = "itemdefIDs, workshopIDs"))
...
public:
	...
	* @param	Key			Steamworks Web API publisher authentication Key.
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Price Sheet"), Category = "SteamCoreWeb|InventoryService|Async")
