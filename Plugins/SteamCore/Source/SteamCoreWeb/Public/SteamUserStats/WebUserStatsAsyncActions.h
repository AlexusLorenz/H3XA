...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Global Achievement Percentages for App"), Category = "SteamCoreWeb|UserStats|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Global Stats for Game"), Category = "SteamCoreWeb|UserStats|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Number of Current Players"), Category = "SteamCoreWeb|UserStats|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Player Achievements"), Category = "SteamCoreWeb|UserStats|Async")
...
public:
	...
	* @param	language		Language to return strings for
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Schema for Game"), Category = "SteamCoreWeb|UserStats|Async")
...
public:
	...
	* @param	AppId			AppID to get achievements for
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get User Stats for Game"), Category = "SteamCoreWeb|UserStats|Async")
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Set User Stats for Game"), Category = "SteamCoreWeb|UserStats|Async")
