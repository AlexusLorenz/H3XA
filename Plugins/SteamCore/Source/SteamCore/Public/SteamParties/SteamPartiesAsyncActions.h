...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Join Party"), Category = "SteamCore|SteamParties|Async")
...
public:
	...
	* @param	Timeout					How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Create Beacon"), Category = "SteamCore|SteamParties|Async")
...
public:
	...
	* @param	Timeout			How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Change Num Open Slots"), Category = "SteamCore|SteamParties|Async")
