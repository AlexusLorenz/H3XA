...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Create Lobby"), Category = "SteamCore|Matchmaking|Async")
...
public:
	...
	* 
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Request Lobby List"), Category = "SteamCore|Matchmaking|Async")
...
public:
	...
	* @param	Timeout			How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Join Lobby"), Category = "SteamCore|Matchmaking|Async")
...
public:
	...
	*    @param	Timeout								How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "sessionSettings"), Category = "SteamCore|Matchmaking|Async")
...
public:
	...
	* @param	Timeout		How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "searchSettings"), Category = "SteamCore|Matchmaking|Async")
...
public:
	...
	* @param	Timeout		How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject"), Category = "SteamCore|Matchmaking|Async")
