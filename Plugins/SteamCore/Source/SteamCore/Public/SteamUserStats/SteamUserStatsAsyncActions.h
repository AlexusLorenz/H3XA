...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Find Leaderboard"), Category = "SteamCore|UserStats|Async")
...
public:
	...
	* @param	Timeout				How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Download Leaderboard Entries"), Category = "SteamCore|UserStats|Async")
...
public:
	...
	* @param	Timeout		How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Request Global Stats"), Category = "SteamCore|UserStats|Async")
...
public:
	...
	* @param	Timeout		How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Request Global Achievement Percentages"), Category = "SteamCore|UserStats|Async")
...
public:
	...
	* @param	Timeout		How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Get Number Of Current Players"), Category = "SteamCore|UserStats|Async")
...
public:
	...
	* @param	Timeout		How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Upload Leaderboard Score", AutoCreaterefterm="scoreDetails"), Category = "SteamCore|UserStats|Async")
...
public:
	...
	* @param	Timeout				How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Find or Create Leaderboard"), Category = "SteamCore|UserStats|Async")
...
public:
	...
	* @param	Timeout		How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Request User Stats"), Category = "SteamCore|UserStats|Async")
...
public:
	...
	* @param	Timeout				How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Download Leaderboard Entries for Users"), Category = "SteamCore|UserStats|Async")
...
public:
	...
	* @param	Timeout				How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Attach Leaderboard UGC"), Category = "SteamCore|UserStats|Async")
