...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Ping Server"), Category = "SteamCore|MatchmakingServers|Async")
...
public:
	...
	* @param	Timeout		How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Request Favorites  Server List"), Category = "SteamCore|MatchmakingServers|Async")
	...
	* @param	Timeout		How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Request Friends Server List"), Category = "SteamCore|MatchmakingServers|Async")
	...
	* @param	Timeout		How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Request History Server List"), Category = "SteamCore|MatchmakingServers|Async")
	...
	* @param	Timeout		How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Request Internet Server List"), Category = "SteamCore|MatchmakingServers|Async")
	...
	* @param	Timeout		How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Request LAN Server List"), Category = "SteamCore|MatchmakingServers|Async")
	...
	* @param	Timeout		How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Request Spectator Server List"), Category = "SteamCore|MatchmakingServers|Async")
...
public:
	...
	* @param	Timeout		How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Server Rules"), Category = "SteamCore|MatchmakingServers|Async")
