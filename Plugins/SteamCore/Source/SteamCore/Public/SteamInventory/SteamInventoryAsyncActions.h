...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Request Eligible Promo Item Definitions IDs"), Category = "SteamCore|Inventory|Async")
...
public:
	...
	* @param	Timeout		How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Request Prices"), Category = "SteamCore|Inventory|Async")
...
public:
	...
	* @param	Timeout			How long we wait for this function to finish before aborting
	*/
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", DisplayName = "Start Purchase"), Category = "SteamCore|Inventory|Async")
